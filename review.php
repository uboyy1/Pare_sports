...
require_once 'config/database.php'; // SESUAIKAN PATH INI JIKA BERBEDA
...
try {
    // --- PERUBAHAN UTAMA DI SINI: TIDAK PERLU CEK BOOKING LAGI ---
    // Cek apakah user_id ini sudah pernah memberikan review untuk lapangan_id ini
    ...
    // --- Proses Penyimpanan Review (Sama seperti sebelumnya) ---
