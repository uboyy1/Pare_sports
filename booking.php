...
// Jika lapangan dengan ID tersebut tidak ada, kembali ke home
if (!$lapangan) {
    header("Location: index.php");
    exit();
}
...
<body>
        ...
        <div class="venue-info">
          ...
          <div class="venue-desc mt-3">
            ...
            <?php if (!empty($lapangan['maps_link'])): ?>
                <p><a href="<?= htmlspecialchars($lapangan['maps_link']) ?>" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;"><?= htmlspecialchars($lapangan['alamat'] ?? 'Alamat tidak tersedia.') ?> <i class="fas fa-external-link-alt fa-xs"></i></a></p>
            <?php else: ?>
  ...
  <!-- Modal Pembayaran & Sukses (tidak ada perubahan) -->
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateBookingSummary() {
            ...
            // Aktifkan tombol bayar jika metode pembayaran sudah dipilih
        ...
        checkScheduleBtn.addEventListener('click', function() {
            ...
            // Ambil data dari tombol dan input tanggal
        ...
        bookingModalEl.querySelectorAll('.payment-method').forEach(method => {
            method.addEventListener('click', function() {
                ...
                updateBookingSummary(); // Cek ulang apakah tombol bayar bisa diaktifkan
            });
        });
